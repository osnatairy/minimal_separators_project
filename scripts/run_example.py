...
if __name__ == '__main__':
    ...
    for pair in pairs:
        print(pair)
        #if pair[1] == "taxi_in" or pair[1] == "departure_delay" or pair[1] == "month" or pair[1] == "arrival_delay" or pair[1] == "day_of_week":
         #   continue

        print("--------------------------------------------")
        Iset = []
        R = bn.g.nodes
        X =pair[0]  # treatments of interest
        Y = pair[1]  # outcomes of interest
        K = 6
        ...
        if len(res["hasse_edges"]) > 0:
            print("************************************")
            print(pair)
            print(res["hasse_edges"])
            print(res["component_to_Zs"])
            print(results)
            print("************************************")
