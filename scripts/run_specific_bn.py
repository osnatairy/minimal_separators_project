...
if __name__ == "__main__":
    ...
    write_bucket_stats_to_csv(bucket_file,buckets_results)
    write_bucket_stats_to_csv(bucket_file, buckets_results,False)

    # v_path, y_path = make_global_bucket_boxplots(
    #     bucket_file,
    ...
    make_bucket_boxplots(
        bucket_file,
        output_dir="bucket_statistics_BN",
        mode="global",
    )
    #make_bucket_boxplots(
    #    bucket_file,
