...
H, Z_sets, closest ,total_time= find_adjustment_sets_for_pair(sem.g, X, Y,"smallminimalseps", R=R, I=I, get_closest_seps=True)
...
print(str(round(results[tuple(sorted(closest[0]))], 5)))
print(str(round(results[tuple(sorted(closest[1]))], 5)))
#print(results)
