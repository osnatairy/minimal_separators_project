# influence_variance_for_observations.py
from typing import Dict, List, Tuple, Callable, Any

from Baysien_Network import BN          # רשת בייסיאנית שלך :contentReference[oaicite:2]{index=2}
...
#
#
# from load_bn_from_json import load_bn_from_json
#
# # טוענים bn
...
# Y = "K"
# A_name = "I"          # הטיפול
# Z_sets = [["G","H"], ["E","F","G"]]   # קבוצות התאמה שונות
# L_vars = ["G"]    # נניח שהמדיניות תלויה ב-G,H (אפשר גם L_vars=[])
#
# # מדיניות סטטית do(I=1)
# policy_fn = static_do_policy(a_star=1)
#
# results = asymptotic_variance_over_Z_sets(
#     bn=bn,
#     Y=Y,
#     A_name=A_name,
#     Z_sets=Z_sets,
...
# )
#
# for Z_key, sigma2 in results.items():
#     print("Z =", Z_key, "  asymptotic Var =", sigma2)